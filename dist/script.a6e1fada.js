...
var carousel = document.querySelector("#carousel__image__container");
var i = 0;
next.addEventListener("click", function () {
  i += 100;
  carousel.style.transform = "translateX(-".concat(i, "%)");
...
var thumbnails = document.querySelectorAll(".carousel_thumbnail");
thumbnails.forEach(function (thumbnail) {
  thumbnail.addEventListener("click", function () {
    ...
    var _iterator = _createForOfIteratorHelper(carousel.children),
        _step;
...
var modalCarousel = document.querySelector(".modal-images");
var modalThumbnails = document.querySelectorAll(".modal_carousel_thumbnail");
var closeModal = document.querySelector("#modal_icon-close");
var modalNext = document.querySelector("#modal_next");
var modalPrevious = document.querySelector("#modal_previous");
var k = 0;
...
modalThumbnails.forEach(function (thumbnail) {
  thumbnail.addEventListener("click", function () {
    ...
    var _iterator2 = _createForOfIteratorHelper(modalCarousel.children),
        _step2;
...
modalNext.addEventListener("click", function () {
  ...
  var _iterator3 = _createForOfIteratorHelper(modalCarousel.children),
      _step3;
...
modalPrevious.addEventListener("click", function () {
  ...
  var _iterator4 = _createForOfIteratorHelper(modalCarousel.children),
      _step4;
...
var cart_icon = document.querySelector("#cart__icon");
...
var cartButton = document.querySelector("#add_to_cart__button");
var checkoutButton = document.querySelector("#cart_checkout__button");
var cartItem = document.querySelector("#cart_item");
var emptyCartMessage = document.querySelector("#cart_empty__message");
var cartDeleteButton = document.querySelector("#cart_delete__button");
var itemCount = document.querySelector("#item_count");
var cartTotal = document.querySelector("#cart_total");
var cartNotification = document.querySelector("#cart__notification");
cartButton.addEventListener("click", function () {
  if (Number(count.innerHTML) > 0) {
    ...
    cartTotal.innerHTML = "$".concat(Number(count.innerHTML) * 125, ".00");
  }
});
